...
cd /root/RFantibody
poetry run python  /root/RFantibody/scripts/rfdiffusion_inference.py \
    ...
    inference.output_prefix=/root/RFantibody/scripts/examples/example_outputs/ab_des_test
