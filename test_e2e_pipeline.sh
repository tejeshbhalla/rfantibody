...
PYTHONPATH=/root/rfantibody/src:/root/rfantibody/include/SE3Transformer python scripts/rfdiffusion_inference.py \
...
PYTHONPATH=/root/rfantibody/src:/root/rfantibody/include/SE3Transformer python scripts/proteinmpnn_interface_design.py \
...
PYTHONPATH=/root/rfantibody/src:/root/rfantibody/include/SE3Transformer python /root/rfantibody/scripts/rf2_predict.py \
